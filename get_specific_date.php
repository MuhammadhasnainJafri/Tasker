    ...
    $date= $_GET['date'];
              ...
              ?>
                ...
                if($user_role == 1){
                  $sql = "SELECT a.*, b.fullname 
                        FROM task_info a
                        INNER JOIN tbl_admin b ON(a.t_user_id = b.user_id) where `t_start_time`<='$date1' and `t_end_time`>='$date2'
                        ORDER BY a.t_end_time DESC";
                  ...
                  FROM task_info a
                  INNER JOIN tbl_admin b ON(a.t_user_id = b.user_id)
                  WHERE a.t_user_id = $user_id and  `t_start_time`<='$date1' and `t_end_time`>='$date2'
                  ORDER BY a.t_end_time DESC";
                } 
