...
--
-- Database: `taskcms_maxtelcomm530491`
--
...
CREATE TABLE `task_info` (
  ...
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '0 = incomplete, 1 = In progress, 2 = complete, 3=close',
...
(1, 'Admin', 'max-tel_admin', 'max-tel@admin.com', 'fae02d4ff7271d48089d9b9265c350be', NULL, 1);
